...
let showingGrabboxes = true;
let showLevelTransitions = true;
let ilSet100P = false;
let toggleKeySounds = false;
let noLag = false;
let tintsEnabled = false;

// finish%
let ilTimesFinishP = [3.8, 3.8, 4.1, 3.4, 14.8, 9.6, 13.4, 9.6, 12.6, 3.9, 3.7, 8.1, 5.0, 5.7, 4.9, 12.4, 34.0, 6.9, 7.9, 6.9, 3.2, 13.4, 3.3, 3.4, 3.5, 5.9, 5.7, 2.4, 9.8, 3.6, 5.9, 2.8, 4.0, 6.4, 10.9, 19.0, 13.8, 1.6, 5.0, 3.4, 6.5, 5.3, 3.8, 8.1, 6.2, 3.9, 17.5, 1.1, 9.3, 6.2, 5.1, 22.4, 13.0];
// complete%
let ilTimesCompleteP = [4.7, 4.9, 6.4, 7.3, 24.2, 15.6, 17.2, 15.7, 24.8, 5.8, 4.7, 18.1, 9.2, 14.1, 4.9, 14.3, 51.5, 7.5, 8.4, 9.1, 3.2, 24.2, 5.5, 5.2, 4.6, 11.5, 9.8, 13.9, 22.3, 3.9, 17.4, 6.7, 7.7, 6.7, 20.1, 27.8, 13.8, 14.8, 5.7, 4.1, 16.0, 11.8, 11.8, 8.1, 14.1, 4.0, 26.5, 8.7, 16.0, 11.4, 11.1, 24.1, 13.0];

let ilTimes = ilTimesFinishP;
...
const tasStringAnyP = [
    ...
    // 005
    'R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R - L L L L L L L L L L - L - - L - L R R - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R LJ L L - - - - - - - - L L L L L L - R R R R R R RJ R R R R R R R R R R R R R R R L L L L L L L L LJ L L L L L L L L L L L L L L - R R R R R R R R RJ R R R R R R R R R R R R R R R R - L L L L L L L L L L L L LJ L L L L L L L L L L L L L L - U R R R R R RD R R R R R L L L L L L R R R R R R R R L - R R R R R R L - R R R R R R RU R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R RU R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R LU R R R R R R R R R R R R R R R R R R R RD R R R R R R R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R L LU R R R R R R R R R R R R R R R R R R R R R U L L L L L L L L L L L LU L L LJ L L L L L L L L L L RU L LD L L L LU - D RU - U J LU R R R - - - - - - - - - L L L L LJU L L L L LU R R RJ - U - - - - - R R R R R RU R R - L L LJU L L L L L L L L L L L L L L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LU LJ L L L L L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L L L L L L L L - LU R - L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L -',
    // 006
    'R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L LJ - - - - - - - - - - - - - - - - - - - - - - - - - - - - - J L L L L L L L L L L L L L L L L L L - - - - - - - - - - - J - - - - - - - - - - - R R R R R R R R R R R R R R R R R R JR R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - U L L L L L LU L L L L L L L L L L L L L L L LJ L L L L L L L L L L L LJ L L L L L L L L L LU L L L L L L LJ L L L L L L L L L L L R R R R R R R R R R R R R R R R RD R R R R R R R R R R R R R R R R R R R R R R - R R R R LU RJ RU R R R R R R R R R R RU R RU R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R L L L L LJ L L L R R R R R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R RJ R RU R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
    // 007
    ...
    // 008
    'L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L - - - RJ R R R R R R R R R R - - - - - - - - - - - - L LJ L L L L L L L L L L L L L L L L L L L L R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L L L L - - - - - - - - - - - - - - - R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RU R L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L - L - - L L - R R - U - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
    // 009
    'R R R R R R RU R R R RU R R R R RJ R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - LJ L L L L L L L L L L L L L L L L L L L L L L L - - - - - - - - - - L L L L L L L L L L L L L L L L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ - - L L L L L L L L L - R R R R R RU RJ R R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R RU R R R R R R R R R R R R LU R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R - - D L - R R R - - - - - - - - - - - - - - - - - - - - - - - - - - J - - - - L L L L L L L L L - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - R RUJ R - L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LU L L L L LJ L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
    // 010
    'R R R R R R R R R R RU R R RU RJ R R R R R R R R R R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R RUJ R R R R R R R R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R RU R R R R RJ R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - J L L L L L - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
    // 011
    'R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R J - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
    // 012
    ...
    // 013
    'R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R J - - - - - - - - - - - - - - - - - - - - - - - - - - - - - J - - - - - - - - - - - - - - - - - - - - - R R R R R R R R RJ R R R R R R R R R - L L L L LU L L L L L L L L L L L L - R R R R R R RJU R R R R R R R R R R R R R R R R R R R R RU R R R R R R R R RJ RU - - - - R R R R R R R R R R R RJU R R R RJD R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R L -',
    // 014
    ...
    // 015
    '- - - - - - - - - R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ L L L L L R R R R R R R R R R R L - - R - - R LJ - - - - - - - - - - - - - - - - - - - - - - - RJ R R R R R R R R R R R R R R R R R R R R R -',
    // 016
    ...
    // 017
    'R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R LJ L L L L L L L L L L L L L L L L L L L L L L L L L L - - - - - - - - - - LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L LJ L L - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
    // 018
    'R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ - - - - - - - R R R R R R R R R R R R R R R R R R R R R - - - - - - - R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - - - J - - R R R R R R R R R R R R R R R R R R R R - R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R L RJ R L - - L R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
    // 019
    'R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - L L L L LJ L L L L L L L L L L L L L L L L L L L L L - - J - - - - - - - - - - - - - - R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R RU R RD R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R RU RD R RU R R R R R R R R R R RJ R R R R R R R R R R L RU R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R RZ LJ LZ R - U L L L LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU L LU L L L L LU L LUJ LZ L L L L L L LU LJ L L L L L L L L LU LZ LU L LU LZ LU L L L L L L L L L L L L L L L LZ LU LZ LU LZ LU LZ LU L L LZ LU LZ LU L LU LZ LU LZ LU LZ LU LZ R R RZ R R R -',
    // 020
    'LZ R R R R R R R R R R R R R R R R R R R R R RZ U R R RU RZ RU RZ RU R RU - - - - - - - - - R R R R R R R R R R R R R RZ R R R R R R R R R R RZ - LZJ R RZ L L RU L L L LZ LU LZ LU LZ LU L LU LZ LU L LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU L LU LZ LU L - Z LU R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RU RZ RU R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU -',
    // 021
    'LU R R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU R R R R R R R R R - - - - - - - - - L L L R R R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RZ RU -',
    // 022
    'R R RJ RZJ L L L L L LZ U L L LU LZ LU L LUZ L LU LD L L L L L L L L LZ L LZ LU L LUZ L L L L L L L L L L L RJ R RZ - - Z L L L L L L L L L L L LZ R RJ RZJ L L L - - - L - - R R R R R R R R R R R RZ R ZJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RZJ R RZ RU R R R R R RZ RU R R R R R RZ RU RZ RU RZ RU RZ RU R  R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R L -',
    // 023
    'LZ R R RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R R R R R R R R RZ RU RZ RU RZ RU RZ RU RZ RU R R R R R -',
    // 024
    'LZ R RJ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU R R R R R R R R R R -',
    // 025
    'LZ R R RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU RZ RU RD R R -',
    // 026
    'LZ R R RU R RU RZ RU R RU R R R R R R R R RZ R Z RU R RU RZ R RU R RU RZ RU RJ RZ RU R RU L U R R RZ RU RZ RU R RU R R R R R R R RZ U LZ R RZJ R Z RU R R R R R R RJU RZ L RZ R RZ - RZ R RZJ R R R R R R R L L - - R R R R R R R R R R R RU RJ R R RU R R R R R R RU RZ L LJ R R RZ RU R R R R R U - LU R R RZ R RZJ R RU R R R R R R R R RU R R R RZ L RZJ R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R R -',
    // 027
    'L L L U R R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU RZ RU R R R R R R R R R R R R R R R R R R R R R RU RZ RU R RU R RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RD - - - - - - - - U - U Z LU',
    // 028
    'LU R J Z U R U Z RU R LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LZ LU LZ LU LZ LU L L L L L L L L L L L L L L L -',
    // 029
    'L L LJ U R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ R R U - U Z U - U Z U - U Z LU L RU RZ RU R RU RZ RU R RU Z U - U Z U - LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LZ LU LZ LU LD L L Z - - RU -',
    // 030
    'LU R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R R R R R R R RZ RU RZ RU R R R R R R R RD R R R RU R RU RZ RU R RU RZ RU R RZ RU RD - RZ R R R R R R - L - U L L LU LZ LU L LZ LU L L L L L -',
    // 031
    'LU L L L L L L L L L L L L L L L L L L L L RZ RU R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R RU RZ RU R RU RZ RU R RU RZ RU Z LU - - R - - R L - - - - Z L L - - - - - - - Z R R R R R R R R R R R RJ R RZ R R RU L -',
    // 032
    'LU R RJ RZ RU R RU RZ RU R U Z U L U Z U R U Z U L U Z U R U Z U L U Z U R U Z U L L L L R LU LZ LU - L L - R R LU Z U - L -',
    // 033
    'LU R R R RU RZ RU R RU RZ RU R RU R R R R R R R R R R R R R R R R R RZ L L - - - - Z U L D R R R R R R R R R R R R R R R R R R RJ R - - - L L L LZ R R R R R R RZ U R R RD RZ RU - R R R R R R R R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU -',
    // 034
    'LU R R R RZ RU R RZ RU RZ RU R R R - L L L L L L - - - - - - - - - - - R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R L LU Z U - U RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU RD R R R -',
    // 035
    'LU R R R R R RU RZ RU R R - - - - R R RD R LU - - - - - - - - - R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ LU L LUZ L LU LZ LU LZ RU Z LU L L LU LZ RU - Z LU L L L L L LU L L LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ RU R RU RZ RU R RU RZ LU L L L -',
    // 036
    'RZ RU R RZ RU RZ RU RZ RU RD R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R RZ - ZJ R RZ - - ZJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - - - - - - - - - - - - - L - - R - - R L - - - - - - - - - - - - - - - - - - - - - - - - - - R R R R R R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L L L R - R RZ RU R RU R R R R RU R RUZ R - R - R R R R LZ RU RDZ L L L L - L - R - R - R RZ RJ RZ L L L ZJ R R RZ R - - RZJ R RZ R L - LZ R RZ R - LZ RU RZ RJ R RZ RU LZ R R RJ RZ LJ L L LZJ R RZ LU R R RZJ R R R RZ R R R R R R R R R R RZ R R R R R R R R R R R R R R R R R R RJ RZ R R R R R R R R R R R R R R RU R LU R RUZJ R RZ R R RZJ R RZ R R R R R R R R R R R R - - RZ R R R R R R R R R RJ RZ R R R RU R LDZ RJ RZ LU RDJ RZ R R R R R R R R RZ R RU R R RU R LU R R RUJ R R R R R RZ L LJ Z L L L L L L L R R R R R R R R R R R R R R R R RU R R R RD R R RU R R R RU J L - U R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RD RJ L L Z L L RU L R RZ RU RZ RU R RZ RU R RU L LJ L U R RUZ R RU R R R RUJ Z L LJ L L L L L LJ L L L R R R R L U R R R R R R R R RD R R R R R R RD RU - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - RU R RU R R R R RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ LU R RU RZ RU R RU RZ RU R RZ R RU RD R R R R R R R R RJ R R R R R R R R R R R R R R R R R RZ R RZJ R RZ R R RZJ R RZ RJ RZ R R R R R R R R R R RZ R R R R R R R R R R R R R R RJ RZ R R R R - - L LU R R R RZ RU R -',
    // 037
    'LU R R RU RZ RU RZ RU RZ RU RZ RU RZ RU R R R RZ R R RU RZ RU R R R RU RZ RU R RU RZ RU R RU RZ RU R R R RU R R R R R R RZ R R L LZ RU L R RD R RU R RU R R R R R R RZ L - - R - - R R R R R R R R R RZ R RJ RU R RU R R - LZ L - - R - - R RZ R R RJ RZ R R R RZJ RU R RU R RJ R RZ L - - R - - R RZ R R RJ R R RZ R RZJ RU R RU R RJ R RZ L - - R - - R RZ R R RJ R R RZ R RZJ RU R RU R RJ R RZ L - - R - - R RZ R R RJ R R RZ R RZJ RU R RU R RJ R RZ L - - R - - R RZ R RZ R R R RZ RJ RZ RU R R R R R RD R R RU R RU RZ RU R RZ RU -',
    // 038
    '- ZJ U L Z U - U Z U - U Z U - U Z U - U Z U - U Z RU R RU RZ RU - Z U -',
    // 039
    'LU R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R RZ RU R RU RZ RU R RU RZ RU R R R R RZ RU RZ R R R RU R RU RZ RU R RU RZ RU R RU RZ RU R R - - - Z U - R R R R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R RZ RU RD RZ RU RZ RU RD R R RU L L L L -',
    // 'LU R R [10:RU RZ RU R] 3:R [2:RZ RU R RU] RZ RU 4:R RZ RU RZ 3:R [3:RU R RU RZ] RU R R 3:- Z U - 4:R [3:RU RZ RU R] RZ [5:RU RZ RU R] 3:R RZ RU RD [2:RZ RU] RD R R RU 4:L',
    // 040
    'LU R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R U Z U - U Z U L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU LD R R RZ -',
    // 041
    'LU R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU LZ LU L LU LZ LU L LZ LU Z U - RU Z U -',
    // 042
    'LU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R
R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R - L L L L L L L L L L - L - - L - L R R - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R LJ L L - - - - - - - - L L L L L L - R R R R R R RJ R R R R R R R R R R R R R R R L L L L L L L L LJ L L L L L L L L L L L L L L - R R R R R R R R RJ R R R R R R R R R R R R R R R R - L L L L L L L L L L L L LJ L L L L L L L L L L L L L L - U R R R R R RD R R R R R L L L L L L R R R R R R R R L - R R R R R R L - R R R R R R RU R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R L L LD - - - - - - U - RU - - - - - - - - - - J - - - - - - - - - - - - - R R R R R L LJ L L L L L L - - - - - - - - - - - - - - - - - - - - - - - R R R R R R R R R R RU R R RU R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R LU R R R R R R R R R R R R R R R RD R R R R R R R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R L LU R R R R R R R R R R R R R R R R R R R R R U L L L L L L L L L L L LU L L LJ L L L L L L L L L L RU L LD L L L LU - D RU - U J LU R R R - - - - - - - - - L L L L LJU L L L L LU R R RJ - U - - - - - R R R R R RU R R - L L LJU L L L L L L L L L L L L L L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LU LJ L L L L L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L L L L L L L L - LU R - L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L -',
	// 006
	'R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L LJ - - - - - - - - - - - - - - - - - - - - - - - - - - - - - J L L L L L L L L L L L L L L L L L L - - - - - - - - - - - J - - - - - - - - - - - R R R R R R R R R R R R R R R R R R JR R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RU R RU R R R R - U L L L L L L L L LU L L L L L L L L L L L L L L L LU L L LJ LU L L L L L L L L L L L L L L L L LJ LU L LU L L L L L LU L L L L L L L L L L L L L L L L L L L L LD L LU L L L L L L L L R R R R R R R R R R RD LU R R R R R R R R R R R R R R R R R R R R R RJ RU R R RU R R R R R R R R R R R R R R R R R R R U J R R R R LU - R RU R R R R R R R R - - - - - - - - - - - - U - - - J R R R R R R R R R R R R R R R R R R R R R R R R L - R R RD R R R R R R R RU R R R R R R RU R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
	// 007
	'R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - - - - - - - - - - - - - - - - - - - - - - - - - - - - L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - R R R R R R R R R R R - L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L - L L - - L L - - L L L L L L L L L L L R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ R R R R R R R R R R R R R R R - L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L LJ L L L L L - L - - L L - R R - - - - - - - - - - - - - - - R R R R R R R R R R R R R R R R R R R RJ R R R - - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L L L L L L L L L L L - - - - - L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - - - - - - - - - - - - - - - - - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
	// 008
	'L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L - - - RJ R R R R R R R R R R - - - - - - - - - - - - L LJ L L L L L L L L L L L L L L L L L L L L R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L L L L - - - - - - - - - - - - - - - R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R - R R R - - L L L R - U L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L U L L L L L L LJ L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R LU R R R RD R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
	// 009
	'R R R R R R RU R R R RU R R R R RJ R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - LJ L L L L L L L L L L L L L L L L L L L L L L L - - - - - - - - - - L L L L L L L L L L L L L L L L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ - - L L L L L L L L L - R R R R R RU RJ R R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R RU R R R R R R R R R R R R LU R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R - - D L - R R R - - - - - - - - - - - - - - - - - - - - - - - - - - J - - - - L L L L L L L L L - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - R RUJ R - L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LU R R R R R R R L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L RU R L R L R R R R R L L L LU R R L L LJ L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RU R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R RU R R R R R R R R R R R R LU R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R RD - - - U D - - - - - - - - - - - - - - - - - - - U - - - - - RJ R R R R R R R R R R R R R L L L L L LUJ L L L L L L L L LU L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LU L L L L LJ L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
	// 010
	'R R R R R R R R R R RU R R RU RJ R R R R R R R R R R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R RUJ R R R R R R R R R R R R R R RU R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R RU RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R L - - R - - R LJ - - - - - - R R R R R R R L L L L L L L L L L LJ L L L R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
	// 011
	'R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R J - - R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L R R R R R R R R R R R R R R R R -',
	// 012
	'R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - R R R - L R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R L L L - - - - - - R R R R R R R R R R R R R R R R R R R R R - L L L L L L L LJ L L L L L L L L L L L L LJ L R R R R - L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L R R R R R R R L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L R R R R L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L - RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
	// 013
	'R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R J - - - - - - - - - - - - - - - - - - - - - - - - - - - - - J - - - - - - - - - - - - - - - - - - - - - R R R R R R R R RJ R R R R R - L L L L L L L L LU L L L L L L L L LU L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L - - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R LU R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R LJ L L L L L L L L L L L L L L L L L L - R R R R RJ R R R R R R R R R R R R R R R R R R R - R R R RJU R R R R R R R R R R R R R R R R R R R R RU R R R R R R R R RJU - - - - - - R R R R R R R R R RU R R R RJD R R R R R R R R R R R R R R RJ R R R R R R R R R R R R L -',
	// 014
	...
	'- - - - - - - - - R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ L L L L L R R R R R R R R R R R L - - R - - R LJ - - - - - - - - - - - - - - - - - - - - - - - RJ R R R R R R R R R R R R R R R R R R R R R -',
	// 016
	'R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L - R R R R R R R R R R R R R R - L L L L L L L L L L L L L L L L L L L - - - - - - - - - - - L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L -',
	// 017
	'R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R LJ L L L L L L L L L L L L L L L L L L L L L L L L L L - - - - - - - - - - LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L LJ L L - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - L L L L L L L L L L L L L L L L L L L L L L L L L L L L L R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - - - - - R R R R R - - - - - R - - - R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R - - - - R R R R R R R R R R R - - - - - - - - - - - - - - - - - - - - - - - - - J L L L L L L L L L L L L L L - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L LJ L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R -',
	// 018
	'R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ - - - - - - - R R R R R R R R R R R R R R R R R R R R R - - - - - - - R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - - - J - - - R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R L RJ R L - - L R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L L - R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R L -',
	// 019
	'R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - L L L L LJ L L L L L L L L L L L L L L L L L L L L L - - J - - - - - - - - - - - - - - R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R RU R RD R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R RU RD R RU R R R R R R R R R R RJ R R R R R R R R R R L RU R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R RZ LJ LZ R - U L L L LZ LU LZ LU LZ LU L L L L L L L L L L L L L LZ LU L LU L L L L L LU L LJU LZ - L L L RU LJ L L L L L LZ LU LZ LU LZ LU LZ LU L L L L L L L L L L L L L L L L L L L LZ LU LZ LU LZ LU LZ LU L L LZ LU LZ LU L L L L R R R -',
	// 020
	'LZ R R R R R R R R R R R R R R R R R R R R R RZ U R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ U - U LZ LU L LU LZ LU L LU LZ LU L LU L L L L L L L L L L L L L L L L L L L L L L L L L L LZ R R R R R - L L L LJ LZ L L L L L L L LU LZ LU LZ LU LZ LU LZ LU LZ LU LD L LU L L LU LZ LU L LU LZ LU L LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU L LU LZ LU L L L R RZ RU R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RU RZ RU R R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R R R R R R RU RZ RU R RU RZ RU R R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R R R R -',
	// 021
	'LU R R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU R R R R R R R R R - - - - - - - - - L L L R R R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RZ RU -',
	// 022
	'R R RJ RZJ L L L L L LZ U L L LU LZ LU L LUZ L LU LD L L L L L L L L LZ L LZ LU L LUZ L L L L L L L L L L L RJ R RZ - - Z L L L L L L L L L L L LZ R RJ RZJ L L L - - - L - - R R R R R R R R R R R RZ - ZJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R L L L L L RZJ L LZ LU L L L L L LD L LZ LU L LU L L L LZ LU L L LU LZ LU L LU LZ LU R RU RZ RU - U Z U - U Z U - - - - U Z U R R R R R Z U L L LD LZ LU L LZ LU LZ LU L LZ LU L LU LZ LU L L L L L L L L L L L Z U - - - Z U - Z U - Z U - Z U - U RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R RU RZ RU R R R R R R R R R R R R R R R R R R R R R R R R R R R R RZ RU RZ RU R R R R R R R R R RZ RU RZ RU R R R R R R R L - - - - - - - D RZ R RZ R RU RZ RU RZ RU R R R R R -',
	// 023
	'LZ R R RU R RU RZ RU R RU RZ RU R RU RZ R RU R R R R R R R R L L L L L L L L LD L L L L L LU L L L L L L L L L L L L LD L L L L L L L L L L L L L L L L L L L L L L LZ U R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU -',
	// 024
	'LU L LJ LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU RZ RU L RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R RZ RU RD R L LZ -',
	// 025
	'L LZJ R U L L LZ LU L RU RZ RU R RU LZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RD -',
	// 026
	'LZ R R RU R RU RZ RU R RU R R R R R R R R RZ R Z RU R RU RZ R RU R RU RZ RU RJ RZ RU R RU L U R R RZ RU RZ RU R RU R R R R R R R RZ U LZ R RZJ R Z RU R R R R R R JU RZ L RZ R RZ - RZ R RZJ R R R R R R R L L - - R R R L L L L L L L L LU R U L L L L L L LJ L L LU L L L L L L LU L L L L L L L L L L L LD L L L L L L L L L L L L L L L L L L L LU L L L LD RU LD L L L L L RD U - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - LJ Z - - - Z - - U - U - - U Z RU RD RU R RU RZ RU RZ RU R RU RZ RU R RU RZ RU R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R R R R R R -',
	// 027
	'L L L U R R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU RZ RU R R R R R R R R R R R R R R R R R R R R R RU RZ RU R RU R RZ RU R RU RZ RU R U Z U - U Z U L U Z U - U Z U - U Z U - U Z U R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RD - - - - - - - - U - U Z LU -',
	// 028
	'LU R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU - LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L L L L L L L L L L LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU L L L L L L L L LZ LU LZ LU LZ LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L L L LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU LZ LU L L L L L L L L L L -',
	// 029
	'L L LJ U R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ R R U - U Z U - U Z U - U Z LU L RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU R RU LZ RU - U LZ U LZ U L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU LZ U D Z U -',
	// 030
	'LU R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R R R R R R R RZ RU RZ RU R R R R R R R RD R R R RU R RU RZ RU R RU RZ RU R RZ RU RD - RZ R R R R R R - L - U L L LU LZ LU L LZ LU L L L L L -',
	// 031
	'LU L L L L L L L L L L L L L L L L L L L L RZ RU R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R RU RZ RU R RU RZ RU R RU RZ RU R LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L L L L L L L L L LD R R R R RZ LU L LU LJ RU L L LU LZ LU L LU R RZ LU R - - U R RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU R RU RZ LU R RU RZ RU R RU RZ RU R R R R R R R R R R R R R R R R R L L L L L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU - - - - - - - - - - - - - - - - - - - - U LJ L L L L LU L LU RZ L L L L L L L L L L L L L L L L L L L L L L L LJ LZ - J LZ L L L L L L L - R R R R R R R R R R R R - - - - - - - Z L LZ - U L L L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LZ LU L LU LZ LU L L L L L L L L L L LZ LU LZ LU LZ LU LZ LU LJ LU - - U Z RU - R R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU R RZ RU R R R R R R RD R R R R R R R R R R R R R R R R R RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU RZ RU RZ RU R R RZ U D -',
	// 032
	'LU R RJ RZ RU R RU RZ RU R RU RZ RU - RU RZ U L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LZ LU L L L L L LU R R Z - - R R R RZJ L U R R RU RZ RU R RU RZ RU R RU RZ RU - - - - - - U Z LU - - - - Z U - U Z RU -',
	// 033
	'LU R R R RU RZ RU R RU RZ RU R RU R R R R R R R R R R R R R R R R R RZ L L - - - - Z U L D R R R R R R R R R R R R R R R R R R RJ R - - L L L L LZ R R R R RZ LU L LD L L L L L L LZ L L L L L L L L LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L L L L L LD R R - - - - - - - - - LU - - R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU RZ RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU R R R R R RZ RU R R R R R RZ RU RD R R R R R R -',
	// 034
	'LU R R R RZ RU R RZ RU RZ RU R R R - L L L L L L - - - - - - - - - - - R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R L LU Z U - U RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ R RU RD RU R R R R R R R R R LD L LZ L LZ R R U - - - - - RZ RU R R R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU RZ RU RZ RU RZ RU -',
	// 035
	'LU R R RU RZ RU R RU RZ RU R RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R RJ R RU Z U - U Z U - U Z U - U Z U L RU Z U - U Z U R UZ L R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L L L L LJ L L L - L - L L L R L - L R R R R R R R R R R R R R R R R R R R R R R RJ RZ R R R R R R R R R R R R R RJ RZ L LJ L - R R R R R R R R R R R R R R R R RJ R RZ J - - - - - R R R R R R R R R R R R R R RU R RU RZ LU - R RU L LU L LZ LU L L L L L - R R R R R R R R RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ R R R R L - - R - - R L Z L - - R - - R RJ R RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R LU LZ LU L LU LZ LU L LU RZ RU R RU Z LU -',
	// 036
	'RZ RU R RZ RU RZ RU RZ RU RD R R R R R R R R R R R R R R R R R RJ R R R R R R R R R R R R R R R R R RZ - ZJ R RZ - - ZJ R R R R R R R R R R R R R R R R R R R R R R R R R R R R - - - - - - - - - - - - - - L - - R - - R L - - - - - - - - - - - - - - - - - - - - - - - - - - R R R R R R R R R R R R R R R R R R R R R R R R R R R R L L L L L L L L L L L L L R - R RZ RU R RU R R R R RU R RUZ R - R - R R R R LZ RU RDZ L L L L - L - R - R - R RZ RJ RZ L L L ZJ R R RZ R - - RZJ R RZ R L - LZ R RZ R - LZ RU RZ RJ R RZ RU LZ R R RJ RZ LJ L L LZJ R RZ LU R R RZJ R R R RZ R R R R R R R R R R RZ R R R R R R R R R R R R R R R R R R RJ RZ R R R R R R R R R R R R R R RU R LU R RUZJ R RZ R R RZJ R RZ R R R R R R R R R R R R - - RZ R R R R R R R R R RJ RZ R R R RU R LDZ RJ RZ LU RDJ RZ R R R R R R R R RZ R RU R R RU R LU R R RUJ R R R R R RZ L LJ Z L L L L L L L R R R R R R R R R R R R R R R R RU R R R RD R R RU R R R RU J L - U R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RD RJ L L L L - - - Z L Z U R RU RZ RU R RU RZ RU R RU L LJ L L L U R RUZ R LU R R RUJ Z L LJ L L L L L LJ L L L R R R R L U R R R R R R R R RD R R R R R R RD RU - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - RU R RU R R R R RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ LU R RU RZ RU R RU RZ RU R RZ R RU RD R R R R R R R RJ RZ L L L L L R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R RJ R L L L - - - - - - - - - - - - - - - - Z - - - - - - - R R R R R R R RZJ - Z R R R R R R R R RUJ - - L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LZ LU LZ L L L LU L L L L L L LU LZ LU L L L L L L D RZ RU - R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R R R R R R R R R R R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU R R -',
	// 037
	'- - - - - - - - - - - LU L LU LZ LU L LU LZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU RZ RU R RU - - - - Z L LZ U L R R R R RU R R R R R R R - - - Z L - - R - - R R R R R R R RZ R RJ RU R RU R R - LZ L - - R - - R RZ R R RJ RZ R R R RZJ RU R RU R RJ R RZ L - - R - - R RZ R R RJ R R RZ R RZJ RU R RU R RJ R RZ L - - R - - R RZ R R RJ R R RZ R RZJ RU R RU R RJ R RZ L - - R - - R RZ R R RJ R R RZ R RZJ RU R RU R RJ R RZ L - - R - - R RZ R RZ R R R RZ RJ RZ RU R R R R R RD R R RU R RU RZ RU R RZ RU -',
	// 038
	'LU R R RU RZ RU R R R R R R R R R R RZ RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU R RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ R R LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LZ LU LZ LU L -',
	// 039
	'LU R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R RZ RU R RU RZ RU R RU RZ RU R R R R RZ RU RZ R R R RU R RU RZ RU R RU RZ RU R RU RZ RU R R - - - Z U - R R R R RU RZ RU R RU RZ RU R RZ RU R R R RU RZ RU R RD R R RZ RU R RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU R R R R R R R R R R R -',
	// 040
	'LU R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R R R R R R R R R R R R RZ RU RZ RU RZ RU RZ RU R RD R R RJU R U Z U - U Z U - LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU LZ LU LZ LU LD R RZ -',
	// 041
	'LU R R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU - LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L LU LZ LU L U Z U - RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RZ RU R R R R R R R R R R R R R R R R RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU RZ RU -',
	// 042
	'LU - U Z U - U Z U R U Z U R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R RU RZ RU R
	'RZ L LJ U R R R RU R RU R RUZ R RZ RU R RU R R R RZ RU R RU R RU R RUZ R RZ RU R RU R R RZ RU R RU L LU RZ R RZ RU R RU RZ RU R RUZ R RZ RU R RU RZ RU RZ - L R R R R R R R R R R R R R R R R R R R R RJ RZ RU RZ U Z R RZ U Z RU RZ R RZ RU R RU RZ RU R RUZ R RZ RU R RU RZ RU R RUZ R RZ RU R RU RZ RU R L L LUZ RJ RZ LU L LU LZ LU L UZ R RZ U - U Z U - RUZ R RZ RU R RU RZ RU RZ R RZ RU R R R R R R R RU RZ RU R R R R R R R R R LZ L LZ LU L L LU LZ LU L LUZ L LZ LU L LU LZ LU L LUZ L LZ LU L LU LZ LU LZ L LZ LU L L L L L L L L L L L L R R R R R R R R R R R R R R R RU RZ RU R RUZ R RZ RU R RZ RU RZ R RZ RU R R R R R R R R R RZ RU RZ -',
	// 052
	'U - UJ L L L U R R RZ RU R RUZ R RZ RU R RU RZ RU R RU R RZ R R RZ RU R RU R RU R RU RZ RU R RU RZ R R RZ RU R RU R RU R RU RZ RU R R R R R R R R R R R R R R R R RZ RJ RZ RU R RU RZ RU RZ R R R R R R R R R R RZ RU RZ RU RZ R RZ RU R R R R RZ RU RJ RZ R RZ RU RZ RU RZ R RZ RU RZ RU R RUZ RJ RZ RU R RU R LU R R RU RZ RU R RU R LU R R RU RZ R R RZ RU R RU R RU R RU RZ RU R RU RZ R R RZ RU R RU R RU R RU RZ RU R RU RZ R RZ RU R RU R RU R RU RZ RU R RU RZ R RZ RU R RU R RU R RU RZ RU R RU RZ R RZ RU R RU R RU R RU RZ RU R RU RZ R RZ RU R RU R RU R RU RZ RU R RU RZ R RZ RU R RU R RU R RU LZ R RZ R Z -  - - - - R RZ LJ - - R - - R R R R R R R RU R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R R - L L L L L L L L L L L L L L L L L L L L L L L L LD L L L L L LZ L LZ - - - - - - - - - U - - - - - - - J D L L L L L L LJ LZ U Z - Z L L L L R R R R R R R R RU - - - - - - J D L L L L L L LJ LZ U Z - Z L L L L R R R R R R R R RU R R R R R R R R R RD L L LU R D LU L R R RD R R R R R R R RU R RZ RU RZ R R RZ L L R - R R R L LU R -',
	// 053
	'RZ L L L L L L L L - U R R R RU R RU R RUZ R RZ RU R RU R R R RZ RU R RU R RU R RUZ R RZ RU R RU R RZ RU R RU R RU R RUZ R RZ RU R RU R RZ RU R RU R RU R RUZ R RZ RU RD R R RU R RU RZ RU R RUZ R RZ RU R RU RZ RU R RUZ R RZ RU R RU RZ RU Z R R R R R R R R RJ RZ R R R R RZ - R R L - - - - U R R Z - Z L L -',
	''
];
...
function tasKeysToString() {
	for (var i = 0; i < tasKeys.length; i++) {
		tasString[i] = '';
		for (var j = 0; j < tasKeys[i].length; j++) {
			let tasFrameString = '';
			for (var k = 0; k < tasKeys[i][j].length; k++) {
				switch (tasKeys[i][j][k]) {
					case 39:
						tasFrameString += 'R';
						break;
					case 37:
			...
			if (tasFrameString.length == 0) tasFrameString = '-';
			tasString[i] += tasFrameString;
...
const keyStringCodes = {'R':39,'L':37,'U':38,'D':40,'J':32,'E':13,'Z':90}
...
function fetchKeySounds() {
	keySounds.map(sound => {
		return fetch('data/key sounds/' + sound.filename)
...
window.onload = function () {
	...
	document.querySelector('input[name=show-grabboxes]').addEventListener('change', function() {
		if (this.checked) showingGrabboxes = true;
		else showingGrabboxes = false;
	});
	if (document.querySelector('input[name=show-grabboxes]').checked) showingGrabboxes = true;
	else showingGrabboxes = false;

	document.querySelector('input[name=show-grid]').addEventListener('change', function() {
		if (this.checked) showingGrid = true;
		else showingGrid = false;
	});
	if (document.querySelector('input[name=show-grid]').checked) showingGrid = true;
	else showingGrid = false;

	document.querySelector('input[name=white-grid]').addEventListener('change', function() {
		if (this.checked) whiteGrid = true;
		else whiteGrid = false;
	});
	if (document.querySelector('input[name=white-grid]').checked) whiteGrid = true;
	else whiteGrid = false;
	...
	document.querySelector('input[name=enable-tints]').addEventListener('change', function() {
		if (this.checked) tintsEnabled = true;
		else tintsEnabled = false;
	});
	if (document.querySelector('input[name=enable-tints]').checked) tintsEnabled = true;
	else tintsEnabled = false;

	document.querySelector('input[name=completep-ils]').addEventListener('change', function() {
		if (this.checked) setILSet(true);
		else setILSet(false);
	});
	if (document.querySelector('input[name=completep-ils]').checked) setILSet(true);
	else setILSet(false);
...
function drawTrajectoryAndSilhouette() {
	...
	function simSolidBelow(px, py, sw) {
	...
	function simSolidAbove(px, py, sw, sh) {
	...
	function simSolidRight(px, py, sw, sh) {
	...
	function simSolidLeft(px, py, sw, sh) {
	...
	function simulateAndDrawTrajectory(c, isControlled) {
		...
		for (let step = 0; step < MAX_STEPS; step++) {
			...
			if (svy < 0 && sy < prevY) {
				if (simSolidAbove(sx, sy, sw, sh)) {
					svy = 0;
				}
			}
			if (svx > 0 && simSolidRight(sx, sy, sw, sh)) { svx = 0; sx = prevX; }
			if (svx < 0 && simSolidLeft(sx, sy, sw, sh))  { svx = 0; sx = prevX; }
			if (step % 4 === 0) dots.push({x: sx, y: sy - sh / 2});
		}
		if (!landed && dots.length === 0) return;

		const dotColorA = isControlled ? '#ffffff' : '#aaffcc';
		const dotColorB = isControlled ? '#ffdd44' : '#00ffaa';
		const lineColor  = isControlled ? '#ffffff' : '#aaffcc';
		const fillColor  = isControlled ? '#44aaff' : '#44ffaa';
		const strokeColor = isControlled ? '#88ccff' : '#88ffcc';
		const crossColor  = isControlled ? '#ffdd44' : '#00ffaa';
		...
		for (let k = 0; k < dots.length; k++) {
			...
			ctx.fillStyle = t < 0.5 ? dotColorA : dotColorB;
			ctx.beginPath();
	...
	for (let i = 0; i < charCount; i++) {
		if (!char[i] || char[i].charState < 5 || char[i].onob || char[i].submerged >= 2) continue;
		simulateAndDrawTrajectory(char[i], i === control);
	}
}
...
function drawCharacters() {
	for (let d = 0; d < (charCount + 1) * 2; d++) {
		...
		if (char[i].charState > 1 && typeof svgChars[currCharID] !== 'undefined') {
			...
			if (!tintsEnabled && char[i].temp > 0 && char[i].temp < 50) {
				ctx.save();
		...
		if (showingGrabboxes && char[i].charState > 5 && control < charCount) {
			ctx.lineWidth = 1;
			if (i == control) {
				if (charD[char[control].id][8]) {
					let omobsDrawn = 0;
					for (let otherc = 0; otherc < charCount; otherc++) {
						if (
							control < 100 &&
							otherc != control &&
							char[otherc].charState > 5 &&
							char[control].standingOn != otherc &&
							Math.abs(char[otherc].x - char[control].x) < 100 &&
							Math.abs(char[otherc].y - char[control].y) < 100 
						) {
							if (char[control].carry && char[control].carryObject === otherc) ctx.strokeStyle = '#0000ff';
							else {
								ctx.strokeStyle = near(control, otherc) ? '#00ff00' : '#ffff00';
								ctx.strokeRect(xOff2(control) + char[control].x - 50+ char[otherc].w, char[control].y - char[otherc].h / 2 - char[control].h2 + 23, 100 - char[otherc].w * 2, char[control].h2);
								ctx.strokeStyle = onlyMovesOneBlock(otherc, control) ? '#00ff00' : '#ffff00';
							}
							let sign = Math.floor((char[control].dire - 1) / 2) * 2 - 1;
							let x2 = char[control].x + xOff2(control) + char[otherc].w * sign;
							ctx.beginPath();
							ctx.moveTo(x2, char[control].y + omobsDrawn*3);
							x2 = Math.abs(Math.ceil((sign * x2) / 30) * 30);
							ctx.lineTo(x2, char[control].y  + omobsDrawn*3);
							ctx.stroke();
							ctx.beginPath();
							ctx.moveTo(x2, char[control].y+5 + omobsDrawn*3);
							ctx.lineTo(x2, char[control].y-5 + omobsDrawn*3);
							ctx.stroke();
							omobsDrawn++;
						}
					}
				...
				ctx.strokeStyle = (char[control].carry && char[control].carryObject === i) ? '#0000ff' : (onlyMovesOneBlock(i, control) ? '#00ff00' : '#ffff00');
				let sign = Math.floor((char[control].dire - 1) / 2) * 2 - 1;
				let x1 = char[i].x + char[i].w * sign;
				ctx.beginPath();
				ctx.moveTo(x1, char[i].y);
				x1 = Math.abs(Math.ceil((sign * x1) / 30) * 30);
				ctx.lineTo(x1, char[i].y);
				ctx.stroke();
				ctx.beginPath();
				ctx.moveTo(x1, char[i].y+5);
				ctx.lineTo(x1, char[i].y-5);
				ctx.stroke();
			}
		}
		if (i == HPRC2) {
...
function drawPossiblyTintedImage(img, x, y, temp) {
	if (tintsEnabled && temp > 0 && temp < 50) {
		ctx.drawImage(
...
function keydown(event) {
	...
	if (event.key == 'g') {
		document.querySelector('input[name=show-grabboxes]').click();
	}
	if (event.key == 't') {
		tassing = !tassing;
...
function draw() {
	...
	switch (menuScreen) {
		...
		case 2:
			drawLevelMap();
			if (_ymouse < 540 && _xmouse < 960 && _xmouse >= 0 && (_xmouse < 587 || _ymouse < 469)) {
				if (_ymouse <= 180) {
...
function toggleRecording() {
	if (recordEnabled) {
		...
		document.getElementById('toggle-recording').innerHTML = 'end record';
	}
}

function setILSet(is100P) {
	ilSet100P = is100P;
	if (is100P) {
		tasString = tasString100P;
		parseTASString();
		ilTimes = ilTimesCompleteP;
	} else {
		tasString = tasStringAnyP;
		parseTASString();
		ilTimes = ilTimesFinishP;
	}
}

function copyRecordString() {
	navigator.clipboard.writeText(keyRecording);
}

function copyTASLevelString() {
...
function setTASLevelString() {
	...
	// reset level
	if (menuScreen === 3 && currentLevel === levelId) {
		wipeTimer = 1;
		transitionType = 0;
	}
}
